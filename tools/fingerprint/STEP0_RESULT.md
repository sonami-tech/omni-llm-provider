...
This was the blocking gate for the entire CCP v2 plan. It confirms:
...
3. Captures are only directly used at Phase 5 (diff harness vs. CCP captures). Doing them then keeps the install + capture work co-located with the diff work.
