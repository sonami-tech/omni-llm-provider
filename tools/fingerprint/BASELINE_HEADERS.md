...
Active baseline: 2026-06-05 against local Claude Code 2.1.165 (re-baselined per REBASELINE.md + capture_baseline.sh). CCP keeps coherent compatibility profiles for 2.1.142 and newer only:
...
- Run `tools/fingerprint/check_claude_code_drift.py` after Claude Code updates to detect installed-version or `cch` algorithm drift before moving `latest`. (Current active: 2.1.165).
