...
PINNED_VERSION = "2.1.269"
PINNED_PROFILE = "cc-2.1.269-sdk-cli"
...
def validate_body(body: str) -> tuple[bool, str]:
	# Live pin: billing header is the no-cch shape and carries the pinned version.
	# There is no checksum to recompute.
...
def main() -> int:
	parser = argparse.ArgumentParser(
		description="Opt-in live drift check for installed Claude Code billing header."
	)
