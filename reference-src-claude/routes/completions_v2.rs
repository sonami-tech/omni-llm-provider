...
pub(crate) fn map_upstream_err(e: UpstreamError) -> AppError {
...
pub(crate) fn derive_session_uuid(session_id: &str) -> uuid::Uuid {
...
pub(crate) fn apply_profile_wire_defaults(
...
pub(crate) fn prepend_claude_code_identity(
    req: &mut MessagesRequest,
    profile: &FingerprintProfile,
    inject_identity: bool,
) {
...
pub(crate) fn apply_replacements_outbound(
...
pub(crate) fn apply_response_to_json(value: &mut serde_json::Value, repl: &crate::replacements::Replacements) {
    match value {
